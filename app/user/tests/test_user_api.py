...
class PublicUserAPITests(TestCase):
    ...
    def test_create_user_with_email_exists_error(self):
        """Test error when attepmting to create a user
    ...
    def test_create_user_with_password_too_short(self):
        """Test error when creating user with too short password"""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': "Test Name",
    ...
    def test_create_token_bad_credentials(self):
        """Test return error when credentials invalid"""
...
class PrivateUserAPITests(TestCase):
    """User API requests with authentication required"""
    ...
    def test_retrieve_profile_success(self):
        """Test retrieving of profile of an authenticated user"""
        res = self.client.get(ME_URL)
